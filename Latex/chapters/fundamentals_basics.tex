...
independent and one reason for chosing a VM design in the first place\parencite[p.11f]{levin}. These \code{.dex} files are being
...
the tool name actually does makes sense but details will follow in a later
chapter).
