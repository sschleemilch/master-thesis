...
For decryption, two different concepts will be explored.
...
(also considering Little and Big Endian).
A reason could be the encoding type how strings are being stored
after the conversion step of \code{dex2oat}. However, that can be
circumvented by using a byte array to store the string
