...
\end{table}
The byte sequence \code{0xe0000091} represents the mnemonic equivalent of a multiplication
...
to memory have to be inverted first (\code{0xe0000091 turns to 0x910000e0}).
