...
As explained in \parencite{jit_intro}, one should go with \code{mmap()} over \code{malloc()}. This is because of protection bits that can only be set at memory page boundaries.
...
For this explicit purpose, the \code{arm-none-eabi} toolchain was used in
