...
in order to init Zygote. However \code{app\_process} does provide the possibility
...
created OAT files for apps with embedded dex and native code with its structure explained in \autoref{chapter:art_internals_app_executable_format}. The invoke method in the \code{Method} class dis implemented as native code, means C++ (see \autoref{method_invoke}).
