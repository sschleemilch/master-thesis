...
writing it into the internal private storage. By checking the outcome file of that process via \code{adb shell} and \code{ls -l}, the file is of course not marked as executable by default but at least the owner and the group is set right.
